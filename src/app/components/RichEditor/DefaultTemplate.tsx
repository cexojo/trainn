      ...
      <div className="lexkit-editor">
        <div className="flex flex-col flex-1" style={{ display: mode === "visual" ? "flex" : "none" }}>
          <RichTextPlugin
            ...
            placeholder={<div className="lexkit-placeholder">{placeholder || "Start typing..."}</div>}
...
export const DefaultTemplate = forwardRef<DefaultTemplateRef, DefaultTemplateProps>(({ className, onReady, placeholder }, ref) => {
