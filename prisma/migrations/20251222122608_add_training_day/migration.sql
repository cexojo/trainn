...
INSERT INTO "new_ExerciseDefinition" ("day", "effectiveReps", "effectiveRir", "effectiveWeight", "exerciseId", "id", "maxReps", "maxRir", "minReps", "minRir", "seriesNumber", "trainingWeekId", "userId") SELECT "day", "effectiveReps", "effectiveRir", "effectiveWeight", "exerciseId", "id", "maxReps", "maxRir", "minReps", "minRir", "seriesNumber", "trainingWeekId", "userId" FROM "ExerciseDefinition";
